...
# long-t2v-1.3B experiments with prompts_rollingforcing.txt
# Same loop/layout as run_14b_rollingforcing.sh; model settings match run_long_video_experiments.sh (1.3B).
...
# 설정 (1.3B — run_long_video_experiments.sh 와 동일한 모델/윈도우 옵션)
GPU_ID=5
TASK="long-t2v-1.3B"
SIZE="832*480"
...
BASE_OUTPUT_DIR="./output_1.3b_rollingforcing_${TIMESTAMP}"
...
echo "==========================================" | tee -a "$LOG_FILE"
echo "1.3B Long Video Experiments (prompts_rollingforcing.txt)" | tee -a "$LOG_FILE"
